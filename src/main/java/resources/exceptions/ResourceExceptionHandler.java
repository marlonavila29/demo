...
import services.excepitons.DataIntegrityViolationException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> dataIntegrityViolationException(DataIntegrityViolationException e, ServletException request){
    ...
    public ResponseEntity<StandardError> validationErrors(MethodArgumentNotValidException e, ServletException request){
